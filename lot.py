...
p.setup(5,p.OUT) #IR-LED1
p.setup(6,p.OUT)#IR-LED2
p.setup(26,p.OUT)#IR-LED3
...
print("We need some basic details to get you there, hope you co-operate with us :)")
print("You can see vacancies with this link https://thingspeak.com/channels/1921272")
